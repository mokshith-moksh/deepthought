        ...
        <div className="flex flex-row gap-6">
          ...
          <a href="/">
            <div className="relative group">
              <img src={beel} alt="Beels" className="w-8 h-8 rounded-full" />
              <div className="children absolute bg-red-600 rounded-full w-2 h-2 -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 transition-all duration-300 ease-in-out opacity-0 group-hover:opacity-100"></div>
            </div>
          </a>
          <a href="/">
            <img
          ...
          <a href="/">
            <img src={Menu} alt="Menu" className="w-8 h-8 rounded-full" />
          </a>
        </div>
      </nav>
    </div>
